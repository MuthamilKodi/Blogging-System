...
public class EditCategoryServlet extends HttpServlet{
	public void service(HttpServletRequest req,HttpServletResponse res){
		try{
			...
			out.println("                <h2>Edit Category</h2>");
			out.println("                <form>");
			out.println("					 <p class='alert_message error' id='error'></p>");
			...
			out.println("                    <button type='button' class='btn' onclick='editCategoryPost()'>Update Category</button>");
			out.println("                </form>");
			out.println("            </div>");
			out.println("        </section>");
