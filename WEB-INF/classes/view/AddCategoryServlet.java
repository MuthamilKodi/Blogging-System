...
public class AddCategoryServlet extends HttpServlet{
	public void service(HttpServletRequest req,HttpServletResponse res){
		try{
			...
			out.println("        <title>ADD CATEGORY</title>");
			...
			out.println("                </div>");
			out.println("                <form>");
			out.println("					 <p class='alert_message error' id='formError'></p>");
			out.println("                    <input type='text' placeholder='Title' id=title>");
			out.println("					 <p class='alert_message error' id='titleError'></p>");
			out.println("                    <textarea rows='4' placeholder='Description' id='desc'></textarea>");
			out.println("					 <p class='alert_message error' id='descError'></p>");
			out.println("                    <button type='button' class='btn' onclick='addCategory()'>Add Category</button>");
			out.println("                </form>");
			out.println("            </div>");
			out.println("        </section>");
			out.println("        <!--========================================ADD CATEGORY END=================================-->");
			out.println("        <footer>");
