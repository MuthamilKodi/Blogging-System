...
public class ManagePostsController extends HttpServlet{
	public void service(HttpServletRequest req,HttpServletResponse res){
		try{
			...
			out.println("		<title>MANAGE POSTS</title>");
			...
			out.println("						<li><a href='/blogsite/manageposts.html' class='active'><h5>Manage Posts</h5></a></li>");
			out.println("				</aside>");
			out.println("				<main>");
			out.println("					<table>");
			out.println("						<thead>");
			...
			out.println("						<tbody>");
			out.println("							<tr>");
			out.println("								<td>dgfkhkjl jhkjlk</td>");
			out.println("								<td>Art</td>");
			out.println("								<td><a href='/blogsite/editcategory.html' class='btn sm'>Edit</a></td>");
			out.println("								<td><a href='' class='btn sm'>View</a></td>");
			out.println("								<td><a href='' class='btn danger'>Delete</a></td>");
			out.println("							</tr>");
			out.println("							<tr>");
			out.println("								<td>gfkjl gjhkjkll gjhklljjhb hbkjdowgdbbcf</td>");
			out.println("								<td>Art</td>");
			out.println("								<td><a href='/blogsite/editcategory.html' class='btn sm'>Edit</a></td>");
			out.println("								<td><a href='/blogsite/deletecategory.html' class='btn danger'>Delete</a></td>");
			out.println("							</tr>");
			out.println("							<tr>");
			out.println("								<td>gfhjkl ttyuiojklnn iukhjbnlhoh nudbufgoefbug griukbcksdbckgru bc</td>");
			out.println("								<td>Art</td>");
			out.println("								<td><a href='/blogsite/editcategory.html' class='btn sm'>Edit</a></td>");
			out.println("								<td><a href='/blogsite/deletecategory.html' class='btn danger'>Delete</a></td>");
			out.println("							</tr>");
			out.println("							<tr>");
			out.println("								<td>vuyfv</td>");
			out.println("								<td>Art</td>");
			out.println("								<td><a href='/blogsite/editcategory.html' class='btn sm'>Edit</a></td>");
			out.println("								<td><a href='/blogsite/deletecategory.html' class='btn danger'>Delete</a></td>");
			out.println("							</tr>");
