...
public class AddPostServlet extends HttpServlet{
	public void service(HttpServletRequest req,HttpServletResponse res){
		try{
			...
			out.println("                </div>");
			out.println("                <form action='' enctype='multipart/form-data'>");
			out.println("                    <input type='text' placeholder='Title'>");
			out.println("                    <select>");
			out.println("                        <option value='1'>Art</option>");
			out.println("                        <option value='1'>Art</option>");
			out.println("                        <option value='1'>Art</option>");
			out.println("                    </select>");
			...
			out.println("                    </div>");
			out.println("                    <button type='submit' class='btn'>Add Post</button>");
			out.println("                </form>");
			out.println("            </div>");
			out.println("        </section>");
